...
print('')
print(bblue('Lançamento de Projétil com Resistência do Ar'))
print('')
print(bred('Digite')
...
try:
    ...
    if op == 'a':
        ...
        # diagram posicao x vs tempo
        plt.plot(tempo, posicao_x, 'ro-',
                 label=f'Sol. Simulador γ = {gamma}')
        ...
        # diagram velocidade x vs tempo
        plt.plot(tempo, velocidade_x, 'ro-',
                 label=f'Sol. Simulador γ = {gamma}')
        ...
        plt.plot(tempo_analitica_res, vx_analitica_res, 'g-',
                 label=f'Sol. Analítica γ = {gamma_gtz}')
        plt.xlim(tempo_analitica[0], )
        plt.ylim(velocidade_x[0] + 0.01, velocidade_x[-1])
        ...
        # diagram velocidade y vs tempo
        plt.plot(tempo, velocidade_y, 'ro-',
                 label=f'Sol. Simulador γ = {gamma}')
