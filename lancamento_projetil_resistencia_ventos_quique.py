...
'''
info = {
    'nome': 'Lançamento de Projétil com Resistência do Ar, Ventos e Quiques',
    'autor': 'James R. Torres',
    'versão': (1, 0),
    'python': (3, 8, 0),
    'descrição': 'calcula o lançamento de projétil com resistência do ar, '
                    'ventos  e quiques'
    'doc_url':
...
print('')
print(bblue('Lançamento de Projétil com Resistência do Ar, Ventos e Quiques'))
print('')
print(bred('Digite')
            ...
            # 4a interação com o usuário: somente os cálulos do simulador.
                ...
                for i in range(N + 1):
                    ...
                    if y >= 0.0:
                        ...
                        posicao_y.append(y)
                        velocidade_x.append(vx)
                        velocidade_y.append(vy - g*h - gamma*(vy - wy0)*h)
                    else:
                        tempo.append(t)
                        posicao_x.append(x)
                        posicao_y.append(y)
