...
info = {
    ...
    'versão': (1, 0),
    'python': (3, 8, 0),
    'descrição': 'calcula o lançamento vertical com resistência'
                ' do ar e quiques'
    'doc_url':
...
print('')
print(bblue('Lançamento Vertical com Resistência do Ar e Quiques'))
print('')
print(bred('Digite')
            ...
            # 4a interação com o usuário: somente os cálulos do simulador.
                ...
                for i in range(N + 1):
                    ...
                    if y >= 0.0:
                        ...
                        tempo.append(t)
                        posicao_y.append(y)
                        velocidade_y.append(vy - g*h - gamma*vy*h)
                    else:
                        tempo.append(t)
                        posicao_y.append(y)
                        velocidade_y.append(vy - g*h - gamma*vy*h)
